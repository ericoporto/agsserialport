...
int AgspPortConfigInterface::Serialize(const char* address, char* buffer, int bufsize)
{
	return 0;
}

void AgspPortConfigReader::Unserialize(int key, const char* serializedData, int dataSize)
{
}
